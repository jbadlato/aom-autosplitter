...
<Layout version="1.6.1">
  ...
  <VerticalHeight>305</VerticalHeight>
  ...
  <Components>
    ...
    <Component>
      ...
      <Settings>
        <Version>1.5</Version>
        <ScriptPath>C:\Users\joeba\git\aom-autosplitter\aom-autosplitter.asl</ScriptPath>
        <Start>True</Start>
        <Reset>True</Reset>
        <Split>True</Split>
        <CustomSettings>
          <Setting id="Individual Level" type="bool">False</Setting>
        </CustomSettings>
      </Settings>
    </Component>
  </Components>
